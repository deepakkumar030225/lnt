...
with st.sidebar:
    ...
    cement_qty_input = st.text_input("Cement Content (kg/m³)  [300–450]", "300, 350, 380, 400, 420, 450")
    wc_input = st.text_input("W/C Ratio  [0.30–0.55]", "0.30, 0.35, 0.40, 0.45, 0.50")
    ...
    st.caption("Enter comma-separated values. All combinations will be evaluated.")
    moulds_input = st.text_input("No. of Moulds  [1–30]", "10")
